...
import com.galeev.operator_chat.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(role.equals("Администратор")){
            ...
            binding.btnShowQuestions.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, QuestionsActivity.class)));
        }
            binding.btnBot.setOnClickListener(v -> getUsersFromDatabase());
            binding.btnQuestion.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, UserQuestionActivity.class)));
